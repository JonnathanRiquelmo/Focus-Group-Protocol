...
\begin{description}
  ...
  \item [Generalização/Especialização:] Associado a este conceito está a ideia de herança de propriedades, ou seja, a atribuição de propriedades particulares a um subconjunto de ocorrências de uma entidade genérica \cite{heuser:2009}. 
\end{description}
