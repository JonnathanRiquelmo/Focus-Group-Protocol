...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{PDFs_Modelos/Exemplo.jpg}
\end{figure}
...
\hlc{Exemplo de Diagrama Entidade-Relacionamento}
  \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{PDFs_Modelos/ModeloER.jpg}
\end{figure}
...
\begin{frame}[t]{Discussão 3}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{PDFs_Modelos/Linguagens.png}
\end{figure}
\end{frame}
